const translation = {
  fr: {
    ...
    reuse_title: '<span className="Reuse-title-font w900 yellow">LE RECYCLAGE DES DRÊCHES</span><br />DE BRASSERIE LORRAINE, EN MARTINIQUE',
